...
<template>
  <nav aria-label="Progress">
    <ol
      role="list"
      class="shadow-sm border border-gray-300 rounded-md divide-y divide-gray-300 md:flex md:divide-y-0"
    >
      <li
      ...
      >
        ...
        >
          <span class="px-6 py-4 flex items-center text-sm font-medium">
            <span
              class="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-emerald-600 rounded-full group-hover:bg-emerald-800"
            >
        ...
        >
          <span
            class="flex-shrink-0 w-10 h-10 flex items-center justify-center border-2 border-emerald-600 rounded-full"
          >
            <span class="text-emerald-800">{{ step.id }}</span>
          </span>
          <span class="ml-4 text-sm font-medium text-emerald-800">{{
            step.name
          }}</span>
        </div>
